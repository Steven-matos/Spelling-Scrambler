  ...
  return (
    <div className="bg-white">
      ...
      <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        >
          <div
            className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#90f3ff] to-[#9089fc] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
